...
## remove control samples samples 
...
save(all_dmps, file='/athena/masonlab/scratch/users/nai2008/DNAm/second_round_of_scripts/rdas/DMPs_by_IDH_status_allDMPs.rda') # all DMPs, irrespective of genomic location
...
# write.csv(out1,file='/athena/masonlab/scratch/users/nai2008/DNAm/second_round_of_scripts/data_tables/DMPs_by_IDH_status_which_overlap_genes_promoters_or_enhancers.csv', row.names=FALSE) 
...
pdf_filename='/athena/masonlab/scratch/users/nai2008/DNAm/second_round_of_scripts/pdfs/DMPs_IDH.pdf'
pdf(file=pdf_filename)

hist(dmps$slope, xlim = c(-0.6, 0.6), xlab='DNAm difference between IDH WT and Mut.', ylab='Frequency', main='DMPs')
...
for (i in 1:n){
	...
	stripchart(as.vector(beta[i,])~factor(as.vector(GRset$IDH_Status), levels=c('WT','Mutated')), vertical = TRUE, method = "jitter", add = TRUE, pch = 21, col = 'black', bg='gray')
}
...
save(all_dmps, file='/athena/masonlab/scratch/users/nai2008/DNAm/second_round_of_scripts/rdas/DMPs_by_IDH_status_adjustedForAgeAndSex_allDMPs.rda') # all DMPs, irrespective of genomic location
...
pdf_filename='/athena/masonlab/scratch/users/nai2008/DNAm/second_round_of_scripts/pdfs/DMPs_IDH_adjustedForAgeAndSex.pdf'
pdf(file=pdf_filename)
