...
palette(col.rainbow)
plot(qc.df$mMed, qc.df$uMed, pch=21, bg=study, col='black', xlab='mMed', ylab='uMed', cex=1.5)
legend(x='topleft',legend=levels(study), pch=15, col=col.rainbow, cex=.7, title="Study ID")

plot(qc.df$mMed, qc.df$uMed, pch=21, bg='gray', col='black',,xlab='mMed', ylab='uMed')
